...
|---------|-------------|------|
| 🤖 **[JetGuard](https://github.com/Zakariajouhari1/JetGuard-Road-Following-and-Collision-Avoidance)** | Autonomous robot with SLAM & obstacle avoidance | Jetson Nano, ROS, CV |
| 🕳️ **[Pothole Detection](https://github.com/Zakariajouhari1/Pothole-Detection-apps-using-yolo-v4)** | YOLOv4 detection system (90% accuracy) | YOLOv4, RPi, OpenCV |
